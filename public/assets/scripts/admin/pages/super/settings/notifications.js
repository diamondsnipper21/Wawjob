    ...
    var fn = {
        ...
        bindEvents: function() {
            ...
            $(this.$container).on('click', 'button.button-submit', function() {
                ...
                if (action == '2') { // Delete
                    $.alert.create({
                        message: 'Are you sure to delete these notification(s)?',
        ...
        modal: {
            ...
            init: function() {
                this.$modalContainer = $('#modal_notification_container');
            },
            ...
            open: function(data) {
                tmpl.arg = 'template';
                var html = tmpl('tmpl_notification', data);

                this.$modalContainer.html(html);
                this.$modal = $('#modal_notification', this.$modalContainer);
