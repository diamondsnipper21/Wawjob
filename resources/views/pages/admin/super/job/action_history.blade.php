...
?>
@extends('layouts/admin/super'.(!empty($user)?'/user':'/job_detail'))
...
<div id="action_histories" class="page-content-section">
	@if (!empty($user))
	@include('layouts.admin.super.job_detail_nav')
	@endif
	<div class="portlet light">
	    <div class="portlet-body">
	    	<form class="form-datatable" action="{{ route('admin.super.job.action_history', ['id' => $job->id]) }}" method="post">
