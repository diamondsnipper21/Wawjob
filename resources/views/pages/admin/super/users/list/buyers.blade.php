...
<table class="table table-striped table-bordered table-hover">
	<thead>
		<tr role="row" class="heading">
			...
			<th width="12%" class="sorting{{ $sort == 'username'?$sort_dir:'' }}" 				data-sort="username">User ID</th>
			...
			<th width="8%" class="sorting{{ $sort == 'job_posted'?$sort_dir:'' }}"   			data-sort="job_posted">Job Posted</th>
			<th width="8%" class="sorting{{ $sort == 'hires'?$sort_dir:'' }}" 					data-sort="hires">Hires</th>
			<th width="8%" class="sorting{{ $sort == 'total_spent'?$sort_dir:'' }}" 			data-sort="total_spent">Total Paid($)</th>
			<th width="8%" class="sorting{{ $sort == 'feedback'?$sort_dir:'' }}" 				data-sort="feedback">Feedback</th>
			<!-- <th width="8%" class="sorting{{ $sort == 'last_activity'?$sort_dir:'' }}" 			data-sort="last_activity">Last Activity</th>
	...
	<tbody>
		...
		<tr>
			...
			<!-- <td>{{ $user->email }}</td> -->
			<td>{{ $user->country }}</td>
			<td align="center">{{ $user->jobs }}</td>
			<td align="center">{{ $user->hires }}</td>
			<td align="right">${{ formatCurrency($user->total_spent) }}</td>
		...
		@empty
		<tr>
			<td align="center" colspan="12">No Users</td>
		</tr>
		@endforelse
	</tbody>
</table>