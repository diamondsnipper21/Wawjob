...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="ticketCreateModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form id="createForm" class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('ticket.create') }}">
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select class="form-control select2" name="type" id="type" data-rule-required="true">
				...
				<div class="modal-footer">
					<a class="btn btn-primary" id="saveBtn">{{ trans('common.submit') }}</a>
