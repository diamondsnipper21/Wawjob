...
<head>
    <meta charset="utf-8">
    <title>{{ !empty($page_title)?$page_title:trans('page.' . $page . '.title') . ' - ' . trans('page.title') }}</title>
...
<body class="layout layout-{{ $role_id }} {{ $role_id }}-page user-page {{ str_replace('.', '-', $page) }} {{ $current_user?'page-logged-in':'page-guest'}}">
    ...
    <div class="page-wrapper page-user">
        <div class="page-section container default-boxshadow">
			...
			@if ( !UserSecurityQuestion::getUserSecurityQueston($current_user->id) )
			<div class="alert alert-danger" role="alert">
				{!! trans('user.change_security_question.warning_set_up_security_question', ['url' => route('user.change_security_question')]) !!}
			</div>
			@endif

            <div class="row">
                <div class="col-sm-3 left-sidebar hidden-mobile">
