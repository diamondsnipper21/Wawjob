...
<head>
	...
	<meta name="author" content="iJobDesk">
	<meta name="description" content="Find freelancers and jobs on iJobDesk online marketplace">
	<meta name="keywords" content="Freelancers, Freelance, Jobs">
...
<body class="layout layout-home page page-{{ str_replace('.', '-', $page) }} {{ $current_user?'page-logged-in':'page-guest'}}">
	...
	<div class="page-wrapper">
		...
		<div class="page-content">
			<div class="default-boxshadow {{ !empty($fullwidth)?'container-fluid':'container' }}">
				@yield('content')
			</div>
		</div>{{-- End Content --}}
	</div>
