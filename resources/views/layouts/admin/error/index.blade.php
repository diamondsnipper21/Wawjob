...
<body class="page" class="page-md admin-page-body admin-{{ $role_id }}-page-body page-error page-{{ $error }}-full-page">
  <div class="page-body">
    <div id="page_body_inner" class="page-body-inner">
      ...
      <div class="page-header">
        ...
        <div class="page-header-top">
          <!-- BEGIN LOGO -->
          <div class="page-logo">
            <a href="{{ route('admin.'.$role_id.'.dashboard') }}" title="{{ config('app.name') }}"><img src="/assets/images/common/logo.png" /></a>
          </div>
          <!-- END LOGO -->
          <!-- BEGIN HEADER MENU -->
        ...
        <!-- END HEADER TOP -->
        <!-- BEGIN HEADER MENU -->
        @include('layouts.admin.'.$role_id.'.commons.top_menu')
        <!-- END HEADER MENU -->
      </div>
      <!-- END HEADER -->
